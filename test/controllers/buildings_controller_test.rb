...
class BuildingsControllerTest < ActionController::TestCase
  ...
  test "should create building" do
    assert_difference('Building.count') do
      post :create, building: { building_description: @building.building_description, building_name: @building.building_name }
    end
  ...
  test "should update building" do
    patch :update, id: @building, building: { building_description: @building.building_description, building_name: @building.building_name }
    assert_redirected_to building_path(assigns(:building))
  end
